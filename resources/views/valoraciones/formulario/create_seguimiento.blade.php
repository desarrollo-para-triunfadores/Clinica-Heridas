...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content animated fadeIn">
        <div class="row">
            <div class="col-md-12">
                  <a href="{{ route('valoraciones.show', $valoracion_id) }}" title="volver a la pantalla anterior" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> volver</a>
                
                <br>
                
                <br>
                <form id="commentForm"  action="/seguimientos" method="POST"  class="form-horizontal">
                    <input id="token-create" type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input name="valoracion_id" id="valoracion_id" value="{{$valoracion_id}}" type="text" class="hide"> 
                    <div id="rootwizard">
                                    ...
                                    <div class="navbar-inner" style="display: inline-block;">
                                        <div class="container">
                                            <ul>
                                                ...
                                                <li><a href="#tab2" data-toggle="tab"><h4>Tratamiento</h2></a></li> 
                                                <li><a href="#tab3" data-toggle="tab"><h4>Confirmar datos</h2></a></li>  
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="observacion" id="observacion" class="form-control" rows="3" maxlength="500" placeholder="campo opcional (máximo 500 caracteres)"></textarea>   
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
