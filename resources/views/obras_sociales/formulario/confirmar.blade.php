        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-borrar" action="" method="POST" accept-charset="UTF-8">
                    ...
                    <p>Usted está a punto de proceder con la eliminación permanente de la obra social seleccionada. Si se encuentra completamente seguro prosiga con la acción.</p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_borrar').click()">eliminar obra social</button>
            </div>
        </div>
    </div>
</div>
