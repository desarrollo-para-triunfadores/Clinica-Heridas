<div class="modal fade" id="modal-agregar-medicamento">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select style="width: 100%" id="combo" class="select2 form-control" multiple>
                        ...
                        <option value="{{$medicamento}}">{{$medicamento->nombre_comercial}}</option>
                        @endforeach
                    </select>
                </div>
                <br>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="agregar_característica()">Agregar medicamento/s</button>
            </div>
        </div>
    </div>
</div>