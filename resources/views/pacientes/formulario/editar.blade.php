    ...
    <div class="modal-dialog" style="width: 80%">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="fecha_nac" type="date" maxlength="50" class="form-control" placeholder="campo requerido" required>                            
                            </div>
                        </div>  
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="foto_perfil" id="foto_perfil" type="file" class="form-control-file" aria-describedby="fileHelp">                            
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select style="width: 100%" id="obrasocial_id" name="obrasocial_id"  placeholder="campo requerido"  class="select2 form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select style="width: 100%" id="medico_id" name="medico_id"  placeholder="campo requerido"  class="select2 form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update').click()">actualizar paciente</button>
            </div>
        </div>
    </div>
</div>
