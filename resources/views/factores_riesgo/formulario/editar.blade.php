    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar factor de riesgo</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update').click()">actualizar factor de riesgo</button>
            </div>
        </div>
    </div>
</div>
