    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-update" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nombre_droga" id="nombre_droga" type="text" maxlength="50" class="form-control" placeholder="campo requerido" required>
                    </div>  
                    <div class="form-group">
                        <label>Nombre comercial:</label>
                        <input name="nombre_comercial" id="nombre_comercial" type="text" maxlength="50" class="form-control" placeholder="campo requerido" required>
                    </div>  
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update').click()">actualizar medicamento</button>
            </div>
        </div>
    </div>
</div>
