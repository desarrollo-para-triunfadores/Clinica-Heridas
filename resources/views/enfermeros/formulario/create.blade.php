    ...
    <div class="modal-dialog" style="width: 80%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/enfermeros" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="$('#boton_submit_crear').click()">registrar enfermero</button>
            </div>
        </div>          
    </div>
</div>