...
class CreateAntecedentesTable extends Migration {
    ...
    public function up() {
        Schema::create('antecedentes', function (Blueprint $table) {
            ...
            $table->boolean('arteriopatia_periferica')->nullable();
            $table->boolean('tratamiento_arteriopatia_periferica')->nullable();
            $table->enum('tipo_tratamiento_arteriopatia_periferica', ['by pass', 'angioplastía', 'prostaglandía'])->nullable();
